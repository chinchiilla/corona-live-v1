...
const ChinaSvg = (props) => {
	...
	C512,105.442,494.833,88.275,473.655,88.275z'
            ...
            <g>
                <path
                    style={{ fill: "#FFE15A" }}
                    d='M85.007,140.731l8.416,25.234l26.6,0.206c3.444,0.026,4.872,4.422,2.101,6.467l-21.398,15.801
		...
		l-21.398-15.8c-2.771-2.046-1.343-6.441,2.101-6.467l26.6-0.206l8.416-25.234C79.297,137.464,83.918,137.464,85.007,140.731z'
                ...
                <path
                    style={{ fill: "#FFE15A" }}
                    d='M181.599,146.949l6.035,8.228l9.739-3.046c1.261-0.394,2.298,1.044,1.526,2.115l-5.962,8.281
		...
		l-9.67-3.261c-1.252-0.423-1.246-2.195,0.009-2.609l9.69-3.196l0.114-10.204C179.129,146.425,180.818,145.884,181.599,146.949z'
                ...
                <path
                    style={{ fill: "#FFE15A" }}
                    d='M144.857,122.419l10.144,1.102l4.328-9.241c0.561-1.196,2.322-0.991,2.591,0.302l2.086,9.988
		...
		l-8.932,4.932c-1.156,0.639-2.461-0.563-1.919-1.768l4.183-9.308l-7.452-6.972C142.805,123.888,143.544,122.277,144.857,122.419z'
                ...
                <path
                    style={{ fill: "#FFE15A" }}
                    d='M160.895,221.313l-6.034,8.23l-9.739-3.046c-1.261-0.394-2.298,1.043-1.526,2.115l5.962,8.281
		...
		l9.67-3.261c1.252-0.423,1.246-2.195-0.009-2.609l-9.69-3.196l-0.114-10.204C163.363,220.789,161.676,220.247,160.895,221.313z'
                ...
                <path
                    style={{ fill: "#FFE15A" }}
                    d='M197.635,198.261l-10.145,1.102l-4.328-9.241c-0.561-1.196-2.321-0.991-2.591,0.302l-2.087,9.988
